...
byte mac[] = {0x2C, 0xF7, 0xF1, 0x08, 0x24, 0x5C}; // 6 byte mac address, used for network config, also change string version
String macStr = "2C F7 F1 08 24 5C"; // string sent to server, compared to config.txt, must match byte version+
IPAddress ip(192, 168, 0, 2); // ip address object stored local static-ip
