...
byte mac[] = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED}; // 6 byte mac address, used for network config, also change string version
String macStr = "DE AD BE EF FE ED"; // string sent to server, compared to config.txt, must match byte version+
IPAddress ip(192, 168, 0, 3); // ip address object stored local static-ip
